...
[x] 70 Phase 70 - Dashboard Work Subject And Workbench Content Convergence
  ...
  [x] 70.1 Section - Canonical Dashboard Work Content Model
    ...
    [x] 70.1.1 Task - Define the canonical dashboard `Work` child-subject shape
      ...
      [x] 70.1.1.1 Subtask - Decide whether the canonical dense inventory lives
        under `Work > Overview`, `Work > Inventory`, or another terse child
        subject without making `Workbench` itself a top-level subject.
      [x] 70.1.1.2 Subtask - Preserve repository-first monitoring, issue and
        ...
        arbitrarily.
      [x] 70.1.1.3 Subtask - Keep the dashboard landing experience lighter and
        more immediately scannable than the full specialist route even when it
        inherits the same domain model.

    [x] 70.1.2 Task - Define shared content and helper boundaries
      ...
      [x] 70.1.2.1 Subtask - Reuse product-owned inventory loading, filter
        shaping, and repo-detail handoff helpers instead of duplicating them in
        dashboard-only code.
      [x] 70.1.2.2 Subtask - Split compact-versus-dense presentation concerns
        ...
        identical.
      [x] 70.1.2.3 Subtask - Keep settings, governed-run, and repo-detail
        follow-up paths product-owned and understandable from either surface.

  [x] 70.2 Section - Dashboard Work Implementation
    ...
    [x] 70.2.1 Task - Implement the converged dashboard inventory surface
      ...
      [x] 70.2.1.1 Subtask - Render the selected dashboard `Work` child subject
