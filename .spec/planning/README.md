...
51. [Phase 57 - Conversation UI Spec Convergence](https://github.com/mikehostetler/jido_code/blob/main/.spec/planning/phase-57-conversation-ui-spec-convergence.md): evolve the current repo-detail conversation panel language into a coherent intake, active work-item conversation, recovery, and cross-surface operator UI that fully matches the conversation specs without abandoning the current LiveView-owned product shell.
