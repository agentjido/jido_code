...
[ ] 69 Phase 69 - Dashboard And Managed-Repo Subject-Tree Adoption
  ...
  [ ] 69.1 Section - Dashboard Subject-Tree Taxonomy And Migration
  ...
  [ ] 69.2 Section - Managed-Repo Subject-Tree Taxonomy And Migration
    ...
    [ ] 69.2.1 Task - Establish the canonical managed-repository subject tree
      ...
      [ ] 69.2.1.1 Subtask - Choose terse parent-subject labels and map
        overview, conversations, semantic inspection, memory, workflows, and
        workspace-repair context into child subjects beneath them.
      [ ] 69.2.1.2 Subtask - Keep repository identity, breadcrumb path, and
      ...
      [ ] 69.2.1.3 Subtask - Preserve the managed-repository route as the
        canonical productive-conversation host even after conversations become a
        child subject inside the newer tree.

    [ ] 69.2.2 Task - Migrate repo detail rendering to the shared shell
      ...
      [ ] 69.2.2.1 Subtask - Render repo detail through the shared ordering of
        route header, breadcrumb lane, parent-subject top rail, child-subject
        sidebar, and selected-pane framing.
      [ ] 69.2.2.2 Subtask - Move child-subject-local conversation, workflow,
