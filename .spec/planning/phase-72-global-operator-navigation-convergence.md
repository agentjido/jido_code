...
[ ] 72 Phase 72 - Global Operator Navigation Convergence
  ...
  [ ] 72.1 Section - Global Wayfinding Model And Ownership
    ...
    [ ] 72.1.1 Task - Formalize the signed-in major-destination model
      ...
      [ ] 72.1.1.2 Subtask - Keep product-wide wayfinding distinct from the
  ...
  [ ] 72.4 Section - Phase Integration Tests
    ...
    [ ] 72.4.1 Task - Add route and browser coverage for global navigation
      Verify that the signed-in wayfinding layer works across major routes and
      deep follow-up surfaces.

      [ ] 72.4.1.1 Subtask - Add route coverage proving the major signed-in
      ...
      [ ] 72.4.1.2 Subtask - Add browser coverage proving operators can move
        across those routes without relying only on browser back behavior or one
        contextual return link.
      [ ] 72.4.1.3 Subtask - Add browser coverage for narrow-screen fallback
