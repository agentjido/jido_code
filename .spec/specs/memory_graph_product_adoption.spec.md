...
<!-- current_truth.reconciled_with_branch: surface feedback, memory components, governed live surfaces, setup-host-shell fallback messaging, and adjacent repo-owned onboarding-reset coverage continue to leave memory adoption product-shaped under this subject. -->
