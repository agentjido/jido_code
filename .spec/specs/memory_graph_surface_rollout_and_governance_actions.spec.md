...
<!-- current_truth.reconciled_with_branch: governed memory helpers plus work-item, evidence, decision, neighboring setup-route host-shell messaging, and adjacent repo-owned onboarding-reset coverage remain part of this rollout subject. -->
