...
<!-- current_truth.reconciled_with_branch: bootstrap-admin creation and entry into the signed-in setup start surface remain current truth here, while later GitHub PAT follow-up still depends on setup-owned secret-encryption readiness rather than changing the bootstrap gate. -->
