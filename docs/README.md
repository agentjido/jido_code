...
This folder contains product-facing and operator-facing documentation for the
`jido_code` repository and the `Jido.Code` product.

## Current Docs

- [`VISION.md`](./VISION.md) - product thesis, trust model, and initial scope
...
These are the next documents the repo should grow after the core framing is stable:
