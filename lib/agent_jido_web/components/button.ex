defmodule AgentJidoWeb.Components.Button do
  @moduledoc """
  Provides a comprehensive set of button components for the `AgentJidoWeb.Components.Button` project.
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/button
  ...
  def button(assigns) do
    assigns = assign_new(assigns, :indicator, fn -> has_indicators?(assigns[:rest]) end)
