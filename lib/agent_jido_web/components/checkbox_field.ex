defmodule AgentJidoWeb.Components.CheckboxField do
  @moduledoc """
  AgentJidoWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
