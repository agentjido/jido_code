defmodule AgentJidoWeb.Components.Stepper do
  @moduledoc """
  The `AgentJidoWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `AgentJidoWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
