  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender JidoCode.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource JidoCode.Accounts.Token
      signing_secret JidoCode.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender JidoCode.Accounts.User.Senders.SendPasswordResetEmail
