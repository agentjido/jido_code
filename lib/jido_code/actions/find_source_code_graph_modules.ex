defmodule JidoCode.Actions.FindSourceCodeGraphModules do
  # covers: architecture.source_code_graph_pod.explicit_actions_drive_analyze_load_refresh_and_query
  # covers: architecture.source_code_graph_pod.sparql_library_is_canonical_query_surface
  @moduledoc """
  Helper action for repository-scoped module lookups over the source_code graph.
  """

  use Jido.Action,
    name: "jido_code_find_source_code_graph_modules",
    description: "Find modules in the loaded source_code graph through an explicit SPARQL helper query.",
    schema: [
      managed_repo_id: [type: :string, default: nil],
      workspace_path: [type: :string, default: nil],
      revision: [type: :string, default: nil],
      module_name_contains: [type: :string, default: nil],
